...
#+END_SRC
 ...
 #+BEGIN_SRC emacs-lisp
   (set-face-attribute 'default nil :family "Victor Mono SemiBold" :height 140)
   (set-face-attribute 'fixed-pitch nil :family "Victor Mono SemiBold" :height 140)
   (set-face-attribute 'variable-pitch nil :family "Roboto Condensed Light" :height 150)
 #+END_SRC
