...
*** centered-window-mode
    I would like to keep this around in the short term just in case
    Olivetti doesn't work out for me.
 #+BEGIN_SRC emacs-lisp
   (require 'centered-window)
   (global-set-key (kbd "<f5>") 'centered-window-mode)
 #+END_SRC
** Font
*** Font Choices
 #+BEGIN_SRC emacs-lisp
   ...
   (set-face-attribute 'variable-pitch nil :family "Lucida Bright")
 #+END_SRC
