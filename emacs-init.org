...
#+END_SRC
 ...
 #+BEGIN_SRC emacs-lisp
   (set-face-attribute 'default nil :family "Victor Mono SemiBold" :height 130)
   (set-face-attribute 'fixed-pitch nil :family "Victor Mono SemiBold" :height 130)
   (set-face-attribute 'variable-pitch nil :family "Roboto Condensed Light" :height 140)
 #+END_SRC
...
**** Aweshell
     ...
     #+BEGIN_SRC emacs-lisp
       (if (not (require 'aweshell nil t))
           (message "`aweshell' not found")
         (message "awe-shell!!!"))
     #+END_SRC
*** Paren matching
