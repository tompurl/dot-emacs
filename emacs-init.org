...
#+END_SRC
 ...
 #+BEGIN_SRC emacs-lisp
   (set-face-attribute 'default nil :family "Victor Mono Light" :height 130)
   (set-face-attribute 'fixed-pitch nil :family "Victor Mono Light" :height 130)
   (set-face-attribute 'variable-pitch nil :family "Roboto Light" :height 130)
 #+END_SRC
