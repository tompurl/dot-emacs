...
**** Keymap
     #+BEGIN_SRC emacs-lisp
       (progn
           (define-key org-journal-mode-map (kbd "n") 'org-journal-new-entry)
           (define-key org-journal-mode-map (kbd "o") (lambda () (interactive) (org-journal-new-entry 't)))
           (define-key org-journal-mode-map (kbd "s") 'org-journal-search)
           (global-set-key (kbd "\C-cj") org-journal-mode-map))
     #+END_SRC
* Magit
** Bootstrap
