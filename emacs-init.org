...
#+END_SRC
 ...
 #+BEGIN_SRC emacs-lisp
   (set-face-attribute 'default nil :family "Input Mono Light" :height 140)
   (set-face-attribute 'fixed-pitch nil :family "Input Mono Light" :height 140)
   (set-face-attribute 'variable-pitch nil :family "Input Sans Light" :height 140)
 #+END_SRC
